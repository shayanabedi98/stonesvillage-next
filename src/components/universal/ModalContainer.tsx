...
export default function ModalContainer({
  ...
  return (
    <div className="z-20 fixed left-0 top-0 flex h-full min-h-screen w-full items-center justify-center bg-neutral-950 bg-opacity-75">
      <div
        ref={modalRef}
        className="modal flex relative max-h-[700px] max-lg:-top-10 max-lg:max-h-[550px] w-full sm:min-w-[700px] max-w-[600px] flex-col gap-8 overflow-auto rounded-md bg-neutral-800 text-bg-color-light px-6 py-6"
      >
